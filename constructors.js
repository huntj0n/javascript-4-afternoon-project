...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  User.prototype.addSavedPost = function(id, title, rating){
    ...
    // this.id = this.savedPosts.push('id')
    // this.title = this.savedPosts.push('title')
    // this.rating = this.savedPosts.push(+rating)
  }
  ////////// PROBLEM 6 //////////
  ...
  // User.prototype.changePostRating = function(searchId, newRating){
